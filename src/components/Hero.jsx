    ...
    >
      ...
      <div className="relative flex gap-16 flex-col lg:flex-row items-center w-full max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex justify-center w-36 sm:w-40 md:w-48 mt-6 mx-auto">
            <p className="hero-pill text-sm px-4 sm:px-5 py-2 rounded-full font-medium tracking-wide inline-flex items-center justify-center gap-2 whitespace-nowrap w-full">
